          ...
          <div className="modal">
            <div className="modal-container">
              <div className="modal-left">
                ...
                <p className="modal-desc">To ProXcure.</p>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="forget">
                    <Link to={'/mail'} replace>
                    <a href="./Forget.jsx">Forget Your Password?</a></Link>
                  </div>
                  <br/>
                ...
                <p className="sign-up">
                  Don't have an account? <Link to={'/'} replace> <a href="#">Register Now</a></Link>
                </p>
              </div>
